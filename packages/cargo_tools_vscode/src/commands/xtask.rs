...
pub const NUMBER_CMDS: usize = 6;

pub const CARGO_TOOLS_XTASK_RUN_ALIAS: &str = "cargo-tools.xtask.runAlias";
pub const CARGO_TOOLS_XTASK_RUN_ALIAS_WITH_ARGS: &str = "cargo-tools.xtask.runAliasWithArgs";
