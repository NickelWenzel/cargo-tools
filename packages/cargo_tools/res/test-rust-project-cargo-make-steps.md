...
[cargo-make] INFO - 
[cargo-make] INFO - Build File: ../test-rust-project/Makefile.toml
...
* **clean-workspace** - Clean all workspace members
* **clippy-workspace** - Run clippy on all workspace members
* **doc-workspace** - Generate documentation for all workspace members
* **fmt-workspace** - Format all workspace members
* **release-build** - Build workspace in release mode
